...
public class AttrAttrgroupRelationServiceImpl extends ServiceImpl<AttrAttrgroupRelationDao, AttrAttrgroupRelationEntity> implements AttrAttrgroupRelationService {
    ...
    public void deleteAttr(List<AttrAttrgroupRelationEntity> relationEntities) {
        relationEntities.forEach(relationEntity -> {
            this.relationDao.delete(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_id",relationEntity.getAttrId()).eq("attr_group_id",relationEntity.getAttrGroupId()));
        });
    }
