...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4FuhPkckrT9F4jF7KthH"; // 请填写您的AccessKeyId。
        String accessKey = "As4a1u0z1x5xeBcKNHybFsnqHeUwT0"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "guli-924"; // 请填写您的 bucketname 。
