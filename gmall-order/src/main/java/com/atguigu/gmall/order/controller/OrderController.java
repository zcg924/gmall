...
public class OrderController {
     ...
     */
    @PostMapping("submit")
    public Resp<Object> orderSubmit(@RequestBody OrderSubmitVO orderSubmitVO){

        OrderEntity orderEntity = this.orderService.orderSubmit(orderSubmitVO);
        if (orderEntity != null) {
